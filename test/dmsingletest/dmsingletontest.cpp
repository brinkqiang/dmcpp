...
TEST(cast, cast)
{
    ...
    std::string str1 = dmcast::lexical_cast(data1);
    std::string str2 = dmcast::lexical_cast(data2);
    std::string str3 = dmcast::lexical_cast(data3);
    std::string str4 = dmcast::lexical_cast(data4);
    std::string str5 = dmcast::lexical_cast(data5);
    std::string str6 = dmcast::lexical_cast(data6);
    std::string str7 = dmcast::lexical_cast(data7);
    std::string str8 = dmcast::lexical_cast(data8);
    std::string str9 = dmcast::lexical_cast(data9);
    std::string str10 = dmcast::lexical_cast(data10);
    std::string str11 = dmcast::lexical_cast(data11);
    std::string str12 = dmcast::lexical_cast(data12);
